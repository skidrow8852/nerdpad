  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]" >
      ...
      <p className="mb-4">
        ...
        <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NerdPad.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to NerdPad, accessible from{' '}
            <a href="https://nerdpad.pro" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
              nerdpad.pro
            </a>
          </p>
        </li>
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">Use of Your Personal Data</h2>
      <p className="mb-4">
        ...
        <p className="mb-4 mt-4">We may share Your personal information in the following situations:</p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h4 className="text-1xl font-semibold mt-6 mb-3">Business Transactions</h4>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <h4 className="text-1xl font-semibold mt-6 mb-3">Law enforcement</h4>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h4 className="text-1xl font-semibold mt-6 mb-3">Other legal requirements</h4>
